package semo.back.service.database.pub;

import com.zaxxer.hikari.HikariDataSource;
import semo.back.service.common.datasource.RoutingDataSource;
...
@EnableJpaRepositories(
        basePackages = {"semo.back.service.database.pub.repository"},
...
public class PubDataConfig {
    ...
    public LocalContainerEntityManagerFactoryBean pubEntityManagerFactory(
        ...
        return builder.dataSource(new LazyConnectionDataSourceProxy(routingDataSource))
                .packages("semo.back.service.database.pub.entity")
