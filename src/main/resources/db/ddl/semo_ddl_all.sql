...
CREATE INDEX idx_tournament_entry_tournament
    ON tournament_entry (tournament_record_id, sort_order, tournament_entry_id);
...
CREATE INDEX idx_tournament_entry_member_entry
    ON tournament_entry_member (tournament_entry_id, sort_order, tournament_entry_member_id);
...
CREATE INDEX idx_tournament_round_tournament
    ON tournament_round (tournament_record_id, sort_order, tournament_round_id);
...
CREATE INDEX idx_tournament_match_round
    ON tournament_match (tournament_round_id, sort_order, tournament_match_id);
...
CREATE INDEX idx_tournament_match_side_match
    ON tournament_match_side (tournament_match_id, side_no);
